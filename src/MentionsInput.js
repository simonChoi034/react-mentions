...
class MentionsInput extends React.Component {
    ...
    renderControl = () => {
        ...
        return (
            <div {...style('control')}>
                ...
                {renderInput
                    ? this.renderCustom(inputProps, singleLine)
                    : this.renderInput(inputProps, singleLine)}
            </div>
        )
    }
    ...
    renderInput = (props, singleLine) => {
        return <TextField inputRef={this.setInputRef} {...props} multiline={!singleLine}/>
    }
